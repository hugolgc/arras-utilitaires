  ...
  <section class="pt-20 pb-10">
    <div class="max-w-screen-xl px-5 mx-auto">
      <div class="mb-10 flex justify-between items-center space-x-5">
        ...
        <button @click="$router.push('/compagnies/add')" class="block px-2 py-1 bg-gray-50 border-gray-200 border rounded text-gray-400 dark:text-gray-500 text-sm focus:outline-none dark:bg-gray-800 dark:border-gray-700">Ajouter</button>
      </div>
